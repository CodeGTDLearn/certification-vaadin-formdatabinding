...
public class ClientViewBinderValidationMessages {
  ...
  public static final String SERVICE_CLIENT_MIN_SIZE_LASTNAME_VALIDATION_MESSSAGE = "min. 3 characters";
  public static final String SERVICE_CLIENT_EMAIL_VALIDATION_MESSSAGE = "Email is required";
