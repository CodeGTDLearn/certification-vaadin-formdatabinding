...
import com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCategoryTypes;
...
import static com.certification.formdatabinding.elevatorsMaintenance.config.AppMessages.APP_MESSAGE_CORRECT_THE_FORM;
import static com.certification.formdatabinding.elevatorsMaintenance.config.AppRoutes.ORDERS_ROUTE;
...
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorServiceOrder.config.ElevatorServiceOrderLabels.*;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorServiceOrder.config.ElevatorServiceOrderTitles.SERVCE_ORDER_FORM_DETAILS_TITLE;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorServiceOrder.config.ElevatorServiceOrderTitles.SERVICE_ORDER_VIEW_TITLE;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorServiceOrder.config.ElevatorServiceOrderValidationMessages.*;
...
public class ElevatorServiceOrderView extends VerticalLayout {
  ...
  private void createForm() {
    ...
    var submitOrder = new Button(ADD_ORDER_BUTTON_LABEL, event -> {
      try {

        var myElevatorServiceOrder = new ElevatorServiceOrder();

        // BEAN: writeBean - write 'fields-values' in an Object(myOrder)
  ...
  private void settingBinder() {
    ...
    binder
         // BINDER: Bind para "propertName"(attributo)
    ...
    // VALIDATOR: Vaadin Standard Validator
    ...
    // VALIDATOR: Lambda Validator for Numbers
    ...
    binder
         ...
         // BINDER: Permitido pelo 'new Binder<>(Order.class)' or 'new Binder<>()'
    ...
    // VALIDATOR: Lambda Validator for Date
