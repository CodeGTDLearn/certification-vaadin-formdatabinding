...
import com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCapacityConverter;
...
import static com.certification.formdatabinding.elevatorsMaintenance.config.AppMessages.APP_MESSAGE_COMPLETE_FIELD_FORM;
import static com.certification.formdatabinding.elevatorsMaintenance.config.AppRoutes.ELEVATOR_CATEGORY_ROUTE;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCategoryLabels.*;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCategoryMessages.ELEVATOR_SPEED_FORMAT_NUMBER_MESSAGE;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCategoryMessages.ELEVATOR_SPEED_VALIDATION_MESSAGE;
import static com.certification.formdatabinding.elevatorsMaintenance.elevatorCategory.config.ElevatorCategoryTitles.*;
import static com.certification.formdatabinding.elevatorsMaintenance.utils.MockedDataSourceElevatorCategory.randomMockedElevatorCategory;
