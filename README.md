...
`java -jar target/formdatabinding-1.0-SNAPSHOT.jar`
...
- `views` folder in `src/main/frontend` contains the elevatorClient-side JavaScript views of your application.
